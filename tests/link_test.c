...
int main(int argc, char** argv)
{
    ...
    if (all || test == 5)
        test3_link_set_name();
    if (all || test == 6)
        test1_link_set_espacio_1();
    if (all || test == 7)
        test2_link_set_espacio_1();
    if (all || test == 8)
        test3_link_set_espacio_1();
    if (all || test == 9)
        test4_link_set_espacio_1();
    if (all || test == 10)
        test1_link_set_espacio_2();
    if (all || test == 11)
        test2_link_set_espacio_2();
    if (all || test == 12)
        test3_link_set_espacio_2();
    if (all || test == 13)
        test4_link_set_espacio_2();
    if (all || test == 14)
        test1_link_set_linked();
    if (all || test == 15)
        test2_link_set_linked();
    if (all || test == 16)
        test3_link_set_linked();
    if (all || test == 17)
        test4_link_set_linked();
    if (all || test == 18)
        test1_link_get_id();
    if (all || test == 19)
        test2_link_get_id();
    ...
    if (all || test == 21)
        test2_link_get_name();
    if (all || test == 22)
        test1_link_get_espacio_1();
    if (all || test == 23)
        test2_link_get_espacio_1();
    if (all || test == 24)
        test1_link_get_espacio_2();
    if (all || test == 25)
        test2_link_get_espacio_2();
    if (all || test == 26)
        test1_link_get_linked();
    if (all || test == 27)
        test2_link_get_linked();
    if (all || test == 28)
        test3_link_get_linked();
