...
int main(int argc, char** argv)
{
    ...
    if (all || test == 1)
        test1_game_rules_create();
    if (all || test == 2)
        test1_game_rules_set_next_action_c();
    if (all || test == 3)
        test2_game_rules_set_next_action_c();
    if (all || test == 4)
        test1_game_rules_set_days_c();
    if (all || test == 5)
        test2_game_rules_set_days_c();
    if (all || test == 6)
        test1_game_rules_set_n_cmd();
    if (all || test == 7)
        test2_game_rules_set_n_cmd();
    if (all || test == 8)
        test1_game_rules_set_notes_c();
    if (all || test == 9)
        test2_game_rules_set_notes_c();
    if (all || test == 10)
        test1_game_rules_get_next_action_c();
    if (all || test == 11)
        test2_game_rules_get_next_action_c();
    if (all || test == 12)
        test3_game_rules_get_next_action_c();
    if (all || test == 13)
        test1_game_rules_get_notes_c();
    if (all || test == 14)
        test2_game_rules_get_notes_c();
    if (all || test == 15)
        test3_game_rules_get_notes_c();
    if (all || test == 16)
        test1_game_rules_get_days_c();
    if (all || test == 17)
        test2_game_rules_get_days_c();
    if (all || test == 18)
        test3_game_rules_get_days_c();
    if (all || test == 19)
        test1_game_rules_get_n_cmd();
    if (all || test == 20)
        test2_game_rules_get_n_cmd();
    if (all || test == 21)
        test3_game_rules_get_n_cmd();
    if (all || test == 22)
        test1_game_rules_update();
    if (all || test == 23)
        test2_game_rules_update();
    if (all || test == 24)
        test3_game_rules_update();
    if (all || test == 25)
        test4_game_rules_update();
