...
int main(int argc, char** argv)
{
    ...
    if (all || test == 3)
        test3_game_management_load_spaces();
    if (all || test == 4)
        test4_game_management_load_spaces();
    if (all || test == 5)
        test1_game_management_load_objects();
    if (all || test == 6)
        test2_game_management_load_objects();
    if (all || test == 7)
        test3_game_management_load_objects();
    if (all || test == 8)
        test4_game_management_load_objects();
    if (all || test == 9)
        test1_game_management_load_links();
    if (all || test == 10)
        test2_game_management_load_links();
    if (all || test == 11)
        test3_game_management_load_links();
    if (all || test == 12)
        test4_game_management_load_links();
