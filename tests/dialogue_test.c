...
int main(int argc, char** argv)
{
    ...
    if (all || test == 1)
        test1_dialogue_create();
    if (all || test == 2)
        test1_dialogue_set_last_cmd();
    if (all || test == 3)
        test2_dialogue_set_last_cmd();
    if (all || test == 4)
        test3_dialogue_set_last_cmd();
    if (all || test == 5)
        test1_dialogue_set_last_cmd_status();
    if (all || test == 6)
        test2_dialogue_set_last_cmd_status();
    if (all || test == 7)
        test3_dialogue_set_last_cmd_status();
    if (all || test == 8)
        test1_dialogue_set_plantilla();
    if (all || test == 9)
        test2_dialogue_set_plantilla();
    if (all || test == 10)
        test3_dialogue_set_plantilla();
    if (all || test == 11)
        test4_dialogue_set_plantilla();
    if (all || test == 12)
        test1_dialogue_set_part1();
    if (all || test == 13)
        test2_dialogue_set_part1();
    if (all || test == 14)
        test3_dialogue_set_part1();
    if (all || test == 15)
        test1_dialogue_set_part2();
    if (all || test == 16)
        test2_dialogue_set_part2();
    if (all || test == 17)
        test3_dialogue_set_part2();
    if (all || test == 18)
        test1_dialogue_set_part3();
    if (all || test == 19)
        test2_dialogue_set_part3();
    if (all || test == 20)
        test3_dialogue_set_part3();
    if (all || test == 21)
        test4_dialogue_set_part3();
    if (all || test == 22)
        test1_dialogue_get_last_cmd();
    if (all || test == 23)
        test1_dialogue_get_last_cmd();
    if (all || test == 24)
        test1_dialogue_get_last_cmd_status();
    if (all || test == 25)
        test2_dialogue_get_last_cmd_status();
    if (all || test == 26)
        test3_dialogue_get_last_cmd_status();
    if (all || test == 27)
        test1_dialogue_get_part1();
    if (all || test == 28)
        test2_dialogue_get_part1();
    if (all || test == 29)
        test3_dialogue_get_part1();
    if (all || test == 30)
        test1_dialogue_get_part2();
    if (all || test == 31)
        test2_dialogue_get_part2();
    if (all || test == 32)
        test3_dialogue_get_part2();
