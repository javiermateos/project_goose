...
int main(int argc, char** argv)
{
    ...
    if (all || test == 25)
        test1_object_set_open_link();
    if (all || test == 26)
        test2_object_set_open_link();
    if (all || test == 27)
        test1_object_get_open_link();
    if (all || test == 28)
        test2_object_get_open_link();
    if (all || test == 29)
        test1_object_set_light_space();
    if (all || test == 30)
        test2_object_set_light_space();
    if (all || test == 31)
        test1_object_get_light_space();
    if (all || test == 32)
        test2_object_get_light_space();
    if (all || test == 33)
        test1_object_set_on();
    if (all || test == 34)
        test2_object_set_on();
