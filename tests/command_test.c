...
int main(int argc, char** argv)
{
    ...
    if (all || test == 2)
        test1_command_set_t_cmd();
    if (all || test == 3)
        test2_command_set_t_cmd();
    if (all || test == 4)
        test3_command_set_t_cmd();
    if (all || test == 5)
        test4_command_set_t_cmd();
    if (all || test == 6)
        test1_command_set_obj_name();
    if (all || test == 7)
        test2_command_set_obj_name();
    if (all || test == 8)
        test3_command_set_obj_name();
    if (all || test == 9)
        test4_command_set_obj_name();
    if (all || test == 10)
        test1_command_set_direction();
    if (all || test == 11)
        test2_command_set_direction();
    if (all || test == 12)
        test3_command_set_direction();
    if (all || test == 13)
        test4_command_set_direction();
    if (all || test == 14)
        test1_command_set_status();
    if (all || test == 15)
        test2_command_set_status();
    if (all || test == 16)
        test3_command_set_status();
    if (all || test == 17)
        test4_command_set_status();
    if (all || test == 18)
        test1_command_get_t_cmd();
    if (all || test == 19)
        test2_command_get_t_cmd();
    if (all || test == 20)
        test1_command_get_obj_name();
    if (all || test == 21)
        test2_command_get_obj_name();
    if (all || test == 22)
        test1_command_get_direction();
    if (all || test == 23)
        test2_command_get_direction();
    if (all || test == 24)
        test1_command_get_status();
    if (all || test == 25)
        test2_command_get_status();
    if (all || test == 26)
        test3_command_get_status();
    if (all || test == 27)
        test1_command_write_log();
    if (all || test == 28)
        test2_command_write_log();
    if (all || test == 29)
        test3_command_write_log();
