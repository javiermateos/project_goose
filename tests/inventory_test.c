...
int main(int argc, char** argv)
{
    ...
    if (all || test == 4)
        test3_inventory_add_id();
    if (all || test == 5)
        test1_inventory_get_ids();
    if (all || test == 6)
        test2_inventory_get_ids();
    if (all || test == 7)
        test3_inventory_get_ids();
    if (all || test == 8)
        test1_inventory_del_id();
    if (all || test == 9)
        test2_inventory_del_id();
    if (all || test == 10)
        test3_inventory_del_id();
    if (all || test == 11)
        test1_inventory_check_id();
    if (all || test == 12)
        test2_inventory_check_id();
    if (all || test == 13)
        test3_inventory_check_id();
    if (all || test == 14)
        test1_inventory_get_num_objects();
    if (all || test == 15)
        test2_inventory_get_num_objects();
    if (all || test == 16)
        test3_inventory_get_num_objects();
    if (all || test == 17)
        test1_inventory_set_ids();
    if (all || test == 18)
        test2_inventory_set_ids();
    if (all || test == 19)
        test3_inventory_set_ids();
