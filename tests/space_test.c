...
int main(int argc, char** argv)
{
    ...
    if (all || test == 21)
        test2_space_set_lit();
    if (all || test == 22)
        test1_space_set_ocupada();
    if (all || test == 23)
        test2_space_set_ocupada();
    if (all || test == 24)
    ...
    if (all || test == 31)
        test4_space_get_gdesc();
    if (all || test == 32)
        test5_space_get_gdesc();
    if (all || test == 33)
        test6_space_get_gdesc();
    if (all || test == 34)
    ...
    if (all || test == 47)
        test2_space_get_lit();
    if (all || test == 48)
        test1_space_get_ocupada();
    if (all || test == 49)
        test2_space_get_ocupada();
    if (all || test == 50)
        test1_space_get_id();
    if (all || test == 51)
        test2_space_get_id();
    ...
    if (all || test == 55)
        test1_space_get_ids_objects();
    if (all || test == 56)
        test2_space_get_ids_objects();
    if (all || test == 57)
    ...
    if (all || test == 60)
        test1_space_check_object();
    if (all || test == 61)
        test2_space_check_object();
    if (all || test == 62)
        test3_space_check_object();
